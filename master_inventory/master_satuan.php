  ...
  <script>
    ...
    var active_2 = 'header_satuan_master';
  </script>
              ...
              <tbody>
                ...
                while ($p = $tampil->fetch_assoc()) : ?>
                  <tr>
                    ...
                    <td>
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal_satuan<?= $i ?>"><i class="fa fa-edit fa-lg"></i></button>
                      <a href="master_inventory/master_satuan.php?stats=delete&id=<?= $p['id'] ?>" class="btn btn-danger" onclick="return confirm('Data akan dihapus?')"><i class="fa fa-trash-o fa-lg"></i></a>
                    </td>
                  </tr>

                  <!-- modal -->
                  <div class="modal fade" id="modal_satuan<?= $i ?>">
                          ...
                          <form action="" method="POST" class="form-horizontal">
                            <div class="box-body">
                              <div class="col-sm-9 pad">
                                <div class="form-group">
                                  <label class="col-sm-4 control-label">Masukan Satuan</label>
                                  <div class="col-sm-7">
